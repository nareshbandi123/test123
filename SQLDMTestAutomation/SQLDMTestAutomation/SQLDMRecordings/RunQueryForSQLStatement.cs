...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("83b5a487-26f9-4eb4-81ef-b05b5ec4529b", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'select * from SQLQueryPlans where PlanID = '2131';' with focus on 'SSMS.MicrosoftSQLServerManagementStudio.QueryEditor'.", repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditorInfo, new RecordItemIndex(9));
            repo.SSMS.MicrosoftSQLServerManagementStudio.QueryEditor.PressKeys("select * from SQLQueryPlans where PlanID = '2131';");
            Delay.Milliseconds(0);
