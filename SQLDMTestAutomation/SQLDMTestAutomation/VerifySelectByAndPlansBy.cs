...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(2));
            repo.MonitoredSqlServerInstancePropertiesDial.SelectTop.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='75') on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(3));
            Validate.AttributeEqual(repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, "Text", "75");
            Delay.Milliseconds(0);
