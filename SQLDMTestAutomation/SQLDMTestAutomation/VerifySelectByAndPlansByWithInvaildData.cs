...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(0));
            repo.MonitoredSqlServerInstancePropertiesDial.SelectTop.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Enabled='True') on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(1));
            Validate.AttributeEqual(repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, "Enabled", "True");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Ctrl+A' Press with focus on 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(2));
            Keyboard.PrepareFocus(repo.MonitoredSqlServerInstancePropertiesDial.SelectTop);
            Keyboard.Press(System.Windows.Forms.Keys.A | System.Windows.Forms.Keys.Control, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '-1' with focus on 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(3));
            repo.MonitoredSqlServerInstancePropertiesDial.SelectTop.PressKeys("-1");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(9));
            repo.MonitoredSqlServerInstancePropertiesDial.SelectTop.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='1') on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(10));
            Validate.AttributeEqual(repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, "Text", "1");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Ctrl+A' Press with focus on 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(11));
            Keyboard.PrepareFocus(repo.MonitoredSqlServerInstancePropertiesDial.SelectTop);
            Keyboard.Press(System.Windows.Forms.Keys.A | System.Windows.Forms.Keys.Control, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking Paste('abc') on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(12));
            repo.MonitoredSqlServerInstancePropertiesDial.SelectTop.Element.InvokeActionWithText("Paste", "abc");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(18));
            repo.MonitoredSqlServerInstancePropertiesDial.SelectTop.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='1') on item 'MonitoredSqlServerInstancePropertiesDial.SelectTop'.", repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, new RecordItemIndex(19));
            Validate.AttributeEqual(repo.MonitoredSqlServerInstancePropertiesDial.SelectTopInfo, "Text", "1");
            Delay.Milliseconds(0);
