...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("64978fe6-bd41-4ef0-a5e0-2a4697bfb54c", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'IderaSQLDiagnosticManagerSQLdmRepo.ShowStoredProcedure' at Center.", repo.IderaSQLDiagnosticManagerSQLdmRepo.ShowStoredProcedureInfo, new RecordItemIndex(12));
            repo.IderaSQLDiagnosticManagerSQLdmRepo.ShowStoredProcedure.MoveTo();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'IderaSQLDiagnosticManagerSQLdmRepo.ShowStoredProcedure' at Center.", repo.IderaSQLDiagnosticManagerSQLdmRepo.ShowStoredProcedureInfo, new RecordItemIndex(13));
            repo.IderaSQLDiagnosticManagerSQLdmRepo.ShowStoredProcedure.Click();
            Delay.Milliseconds(200);
