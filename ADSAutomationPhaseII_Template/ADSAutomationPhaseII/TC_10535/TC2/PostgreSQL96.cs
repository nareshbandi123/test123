...
{
    /// <summary>
    /// Description of PostgreSQL96.
    /// </summary>
    [TestModule("888CDD99-08E1-4F31-9F50-C7564BB2A4D4", ModuleType.UserCode, 1)]
    public class PostgreSQL96 : BaseClass, ITestModule
    {
        public PostgreSQL96()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.PostgreSQL, "196");
