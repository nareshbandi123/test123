...
{
    /// <summary>
    /// Description of SysbaseASE16.
    /// </summary>
    [TestModule("332D5728-64D1-4DCF-85C2-36ADCC2D3948", ModuleType.UserCode, 1)]
    public class SysbaseASE16 : BaseClass, ITestModule
    {
        public SysbaseASE16()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.SybaseASE, "16");
