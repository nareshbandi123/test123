...
{
    [TestModule("E9E7F04D-EFB5-42BC-A765-9C36C675C758", ModuleType.UserCode, 1)]
    public class Derby1014 : BaseClass, ITestModule
    {
           public Derby1014()
        {
        }
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.ApacheDerby, "1014");
