...
{
    [TestModule("61B8ED91-56A3-43B1-8E24-A66115BA1674", ModuleType.UserCode, 1)]
    public class MSSQLAzureDB : BaseClass, ITestModule
    {
        public MSSQLAzureDB()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.MSSQLAzure);
