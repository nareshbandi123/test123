...
{
    /// <summary>
    /// Description of Teradata1510.
    /// </summary>
    [TestModule("99D32025-9A8D-4F2E-B95B-DE0C6841D758", ModuleType.UserCode, 1)]
    public class Teradata1510 : BaseClass, ITestModule
    {
        public Teradata1510()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.TeradataDatabase, "1510");
