...
{
    /// <summary>
    /// Description of MSSQLDB2017.
    /// </summary>
    [TestModule("203E54B3-0084-4FCF-B4F5-F3C24DE7F9E5", ModuleType.UserCode, 1)]
    public class MSSQLDB2017 : BaseClass, ITestModule
    {
        public MSSQLDB2017()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.MSSQLServer, "2017");
