...
{
    /// <summary>
    /// Description of SysbaseIQ154.
    /// </summary>
    [TestModule("95F86CAB-8E73-4343-ADE4-30ED6D6B6770", ModuleType.UserCode, 1)]
    public class SysbaseIQ154 : BaseClass, ITestModule
    {
        public SysbaseIQ154()
        {
       ...
       void ITestModule.Run()
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.SybaseIQ, "154");
