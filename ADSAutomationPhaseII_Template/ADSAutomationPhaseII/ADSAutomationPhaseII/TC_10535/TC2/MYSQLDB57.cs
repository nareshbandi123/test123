...
{
    /// <summary>
    /// Description of MYSQLDB57.
    /// </summary>
    [TestModule("1F98278F-3F88-498C-9C59-F65180B56074", ModuleType.UserCode, 1)]
    public class MYSQLDB57 : BaseClass, ITestModule
    {
        public MYSQLDB57()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.MySQL, "57");
