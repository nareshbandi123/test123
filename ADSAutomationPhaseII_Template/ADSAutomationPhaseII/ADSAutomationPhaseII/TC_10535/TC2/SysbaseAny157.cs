...
{
    /// <summary>
    /// Description of SysBaseAny17.
    /// </summary>
    [TestModule("43C010C4-5491-4B84-A467-BA8C50333867", ModuleType.UserCode, 1)]
    public class SysbaseAny157 : BaseClass, ITestModule
    {
        public SysbaseAny157()
        {
       ...
       void ITestModule.Run()
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.SybaseAnywhere, "157");
