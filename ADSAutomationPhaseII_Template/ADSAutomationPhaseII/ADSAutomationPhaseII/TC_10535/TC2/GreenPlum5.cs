...
{
    /// <summary>
    /// Description of GreenPlum.
    /// </summary>
    [TestModule("72AA0E3D-ADBD-444B-B854-6BBEF1F9A90D", ModuleType.UserCode, 1)]
    public class GreenPlum5 : BaseClass, ITestModule
    {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.Greenplum, "5");
