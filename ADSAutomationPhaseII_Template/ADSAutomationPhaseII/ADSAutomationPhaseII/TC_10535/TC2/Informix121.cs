...
{
    /// <summary>
    /// Description of Informix121.
    /// </summary>
    [TestModule("1C59105E-2D2D-411D-8A74-3A2FFBBC7B32", ModuleType.UserCode, 1)]
    public class Informix121 : BaseClass, ITestModule
    {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.Informix, "121");
