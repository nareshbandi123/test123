...
{
    /// <summary>
    /// Description of GreenPlum4312.
    /// </summary>
    [TestModule("75454659-4614-434B-80B5-1EE666D95C44", ModuleType.UserCode, 1)]
    public class GreenPlum4312 : BaseClass, ITestModule
    {
        
        public GreenPlum4312()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.Greenplum, "4312");
