...
namespace ADSAutomationPhaseII.TC_10535.TC2
{
    ...
    /// </summary>
    [TestModule("B436B640-6C3F-4710-80EB-8826D2172CD4", ModuleType.UserCode, 1)]
    public class Derby1013 : BaseClass, ITestModule
    {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.ApacheDerby, "1013");
