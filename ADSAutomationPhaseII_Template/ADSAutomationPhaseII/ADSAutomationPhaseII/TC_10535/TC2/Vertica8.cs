...
{
    /// <summary>
    /// Description of Vertica8.
    /// </summary>
    [TestModule("0C8687DD-8E44-49A1-BC5C-AC05D5C46CBA", ModuleType.UserCode, 1)]
    public class Vertica8 : BaseClass, ITestModule
    {
        public Vertica8()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.Vertica, "8");
