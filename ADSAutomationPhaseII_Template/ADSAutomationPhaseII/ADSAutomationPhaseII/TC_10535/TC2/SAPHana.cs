...
{
    /// <summary>
    /// Description of SAPHana.
    /// </summary>
    [TestModule("76C519F3-79EB-4BD3-9FA3-18CC8799FCEC", ModuleType.UserCode, 1)]
    public class SAPHana :BaseClass, ITestModule
    {
        public SAPHana()
        {
        ...
        bool StartProcess()
        {
        	try 
        	{
        		...
        		Steps.SelectNew();
        		Steps.SelectDataTypeAndVersion(Steps.DatabaseTypes.SAPHana);
